            ...
            <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                ...
                <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
                    <input
                        ...
                        className='outline-none text-2xl sm:text-2xl  border-b-2 border-gray-200 p-2'
                    />
                    {user && (
                    ...
                    <div className='flex flex-col'>
                        <div>
                            <p className='mb-2 font-semibold text-lg sm:text-xl'>Choose your pin category</p>
                            <select
                                onChange={(e) => setCategory(e.target.value)}
                                className='outline-none w-4/5 text-base border-b-2 border-gra-200 p-2 rounded-md cursor-pointer'
                            >
